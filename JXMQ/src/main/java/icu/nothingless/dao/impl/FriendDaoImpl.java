...
public class FriendDaoImpl implements IFriendDao<FriendshipBean> {
    ...
    public R<Boolean> applyFriend(Long userId, Long friendId, String applyMsg) throws Exception {
        ...
        try {
            ...
            return id != null && id > 0 ? R.success(true) : R.error("申请失败");
    ...
    // 获取双向好友关系(检查是否已经是好友)
    public R<Boolean> isFriend(Long userId, Long friendId) throws Exception {
        /*
         * String sql =
    ...
    // 拒绝好友申请
    public R<Boolean> rejectFriend(Long userId, Long friendId) throws Exception {
        /*
        ...
        try {
            ...
            return updated > 0 ? R.success(true) : R.error("拒绝好友申请失败");
        } catch (SQLException e) {
    ...
    // 删除好友(双向删除)
    public R<Boolean> deleteFriend(Long userId, Long friendId) throws Exception {
        StringBuilder sql = new StringBuilder();
        sql.append("UPDATE ").append(TABLENAME).append(" SET ")
    ...
    // 修改备注和分组
    public R<Boolean> updateFriendInfo(Long userId, Long friendId, String remark, String groupName) throws Exception {
    ...
    // 获取分组列表
    public R<List<String>> getGroups(Long userId) throws Exception {
