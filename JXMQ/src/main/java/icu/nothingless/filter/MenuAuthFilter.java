...
public class MenuAuthFilter implements Filter {
    ...
    static {
        ...
        // 其他需要权限控制的页面
        // PAGE_ROLE_ACCESS.put("system_config", Arrays.asList("Super Administrator", "Admin"));
    }
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
        ...
        try {
            // 解析原始菜单响应
            java.lang.reflect.Type respType = new TypeToken<RespEntity<List<MenuItem>>>(){}.getType();
            RespEntity<List<MenuItem>> rawResponse = gson.fromJson(jsonResponse, respType);
            ...
            // 重新构建响应
            RespEntity newResponse = RespEntity.success(filteredMenu);
            String newJson = gson.toJson(newResponse);
