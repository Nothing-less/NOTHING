...
var SHA256Util = {
    ...
    encrypt: function(message) {
        ...
        function sha256Bytes(bytes) {
            ...
            var totalLen = data.length + padLen + 8;
            ...
            // 转换为十六进制字符串
            var toHex = (n) => n.toString(16).padStart(8, '0');
    ...
    encryptFormField: function(plainFieldId, hiddenFieldId, salt) {
        var plainInput = document.getElementById(plainFieldId);
        ...
        var plainPassword = plainInput.value;
        if (!plainPassword) {
            alert('请输入密码');
            return false;
        }
        ...
        // 加密（可选加盐）
        var encrypted = salt ? this.encryptWithSalt(plainPassword, salt) 
