...
<body>
    ...
    <script>
        ...
        const pageUrls = {
            'dashboard': '<%= request.getContextPath() %>/pages/dashboard',
            'users': '<%= request.getContextPath() %>/pages/users',
            'orders': '<%= request.getContextPath() %>/pages/orders',
            'products': '<%= request.getContextPath() %>/pages/products',
            'analytics': '<%= request.getContextPath() %>/pages/analytics',
            'settings': '<%= request.getContextPath() %>/pages/settings'
        };
